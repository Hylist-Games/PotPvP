...
// in this case it's too unreadable without these.
import static net.frozenorb.potpvp.PotPvPLang.LEFT_ARROW_STRING;
import static net.frozenorb.potpvp.PotPvPLang.RIGHT_ARROW_STRING;
import static org.bukkit.ChatColor.*;

// see static imports used by this class
@UtilityClass
public final class QueueItems {

    public static final ItemStack JOIN_SOLO_UNRANKED_QUEUE_ITEM = new ItemStack(Material.PAPER);
    public static final ItemStack LEAVE_SOLO_UNRANKED_QUEUE_ITEM = new ItemStack(Material.EMPTY_MAP);
    ...
    static {
        ItemUtils.setDisplayName(JOIN_SOLO_UNRANKED_QUEUE_ITEM, LEFT_ARROW_STRING + AQUA.toString() + BOLD + "Join Quickmatch Queue" + RIGHT_ARROW_STRING);
        ItemUtils.setDisplayName(LEAVE_SOLO_UNRANKED_QUEUE_ITEM, LEFT_ARROW_STRING + RED.toString() + BOLD + "Leave Quickmatch Queue" + RIGHT_ARROW_STRING);
        ...
        ItemUtils.setDisplayName(JOIN_PARTY_UNRANKED_QUEUE_ITEM, LEFT_ARROW_STRING + GREEN.toString() + BOLD + "Join 2v2 Unranked" + RIGHT_ARROW_STRING);
        ItemUtils.setDisplayName(LEAVE_PARTY_UNRANKED_QUEUE_ITEM, LEFT_ARROW_STRING + RED.toString() + BOLD + "Leave 2v2 Unranked" + RIGHT_ARROW_STRING);
