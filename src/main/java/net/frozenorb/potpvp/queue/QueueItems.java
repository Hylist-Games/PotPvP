...
public final class QueueItems {
    ...
    static {
        ItemUtils.setDisplayName(JOIN_SOLO_QUEUE_ITEM, LEFT_ARROW_STRING + AQUA.toString() + BOLD + "Join Quickmatch Queue" + RIGHT_ARROW_STRING);
        ItemUtils.setDisplayName(LEAVE_SOLO_QUEUE_ITEM, LEFT_ARROW_STRING + RED.toString() + BOLD + "Leave Quickmatch Queue" + RIGHT_ARROW_STRING);
        ...
        ItemUtils.setDisplayName(JOIN_PARTY_QUEUE_ITEM, LEFT_ARROW_STRING + GREEN.toString() + BOLD + "Join 2v2 Unranked" + RIGHT_ARROW_STRING);
        ItemUtils.setDisplayName(LEAVE_PARTY_QUEUE_ITEM, LEFT_ARROW_STRING + RED.toString() + BOLD + "Leave 2v2 Unranked" + RIGHT_ARROW_STRING);
